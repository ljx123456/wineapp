package yongchao.com.wineapp.utils.view.scrollview;
...
public class TabWithScrollView extends ScrollView {
     ...
     * @param tabLayout
     */
    public void setupWithTabLayout(XTabLayout tabLayout) {
        if (mTabLayout != null) {
//            mTabLayout.removeOnTabSelectedListener(mTabSelectedListener);
    ...
    XTabLayout.OnTabSelectedListener mTabSelectedListener = new XTabLayout.OnTabSelectedListener() {
        @Override
